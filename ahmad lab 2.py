...
day_today = int(input( "what is day today" ))
days_trip = int(input( "trip duration" ))                       
Day_number = (days_trip + day_today) % 7
print(f" Your trip starts on day ", day_today , " and lasts " , days_trip , "days."  " You are back on day ", Day_number , ".")
#---------------------------------------------------------
# Submission (10 marks):
