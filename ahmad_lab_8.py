...
def remove_duplicates_set(s):
    """
    This function remove the dupilcates from the string s.

    Return:
    The function will keep the first occurence of each character and removes any later duplicate.

    Example:
    remove_duplicates("apple") == "aple"
    remove_duplicates("Popsipple") == "Popsile"
    """
...
# Your unit tests
assert remove_duplicates("apple") == "aple"
assert remove_duplicates("Popsipple") == "Popsile" # (Notice: 'P' and 'p' are different chars)
...
def gem_counting(stones, gems):
    ...
    Parameter: 
    Stones: This string represent stones
    Gems: This string represent gems

    Return:
    The function returns how many character in stone are gems.
...
def students_id(ids):
    """
    Count the number of different student IDs in a list.

    Parameter: 
    Ids: This string represent list of student IDs.

    Return: The function returns how many smart students use the shuttle service.
    """

    smart_student_ids = set(ids)
    
    return len(smart_student_ids)
...
def students_id_occurrences(ids):
    """
    Count the occurence the of student id everytime it is used.

    Parameter: 
    student ids: list of student ids

    Return: A dictionary where key is student id and value is number of time it is. used.
...
def word_frequency(paragraph):
    ...
    The function returns a dictionary where key is the word and value is the number of time the word appear in the paragraph.
